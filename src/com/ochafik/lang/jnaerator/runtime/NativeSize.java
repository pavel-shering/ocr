 ...
 * Can be also used to model the 'long' C type for libraries known to be
 * compiled with GCC or LLVM even on Windows. (NativeLong on Windows is only
 * okay with MSVC++ libraries, as 'long' on Windows 64 bits will be 32 bits with
 * MSVC++ and 64 bits with GCC/mingw)
 *
 * @author ochafik
 */
